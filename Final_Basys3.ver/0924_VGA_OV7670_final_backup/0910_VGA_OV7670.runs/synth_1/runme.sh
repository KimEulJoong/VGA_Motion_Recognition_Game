...
HD_PWD='C:/ssssssssssssssssssss/0925_bbbaaaccckkkuuuppp/0924_VGA_OV7670_final_backup/0910_VGA_OV7670.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_Camera_Display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGA_Camera_Display.tcl
