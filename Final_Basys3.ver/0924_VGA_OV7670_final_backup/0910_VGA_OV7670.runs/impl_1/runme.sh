...
HD_PWD='C:/ssssssssssssssssssss/0925_bbbaaaccckkkuuuppp/0924_VGA_OV7670_final_backup/0910_VGA_OV7670.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_Camera_Display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGA_Camera_Display.tcl -notrace
